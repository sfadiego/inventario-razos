...
export const FormProveedor = ({ isOpen, closeModal }: IFormProveedorProps) => {
    const { formikProps, isPending } = useCliente({ closeModal });
    return (
        <Modal title="Cliente" subtitle="Crea o actualiza un cliente" isOpen={isOpen} onClose={closeModal} className="m-4 max-w-[700px]">
