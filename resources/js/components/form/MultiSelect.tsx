...
const MultiSelect: React.FC<MultiSelectProps> = ({ label, options, defaultSelected = [], onChange, disabled = false }) => {
            ...
            >
              <div className="flex flex-col">
                {options.map((option, index) => (
                  ...
                  >
                    <div className={`relative flex w-full items-center p-2 pl-2 ${selectedOptions.includes(option.value) ? 'bg-primary/10' : ''}`}>
